...
void setup_scr_screen(lvgl_ui_t *ui)
{
    ...
    //------------------------------------------------------------------------------------------------------------
    //Write codes screen_label_connect_state
    //Write codes screen_label_connect_state
    ui->screen_label_connect_state = lv_label_create(ui->screen_cont_1);
    lv_label_set_text(ui->screen_label_connect_state, "连接中...");
    lv_label_set_long_mode(ui->screen_label_connect_state, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_connect_state, 70, 92);
    lv_obj_set_size(ui->screen_label_connect_state, 103, 37);

    //Write style for screen_label_connect_state, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_connect_state, lv_color_hex(0xD01FBB), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_connect_state, &lv_font_AlimamaShuHeiTi_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_label_connect_state, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_label_connect_state, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_label_connect_state, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_connect_state, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_label_connect_state, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
